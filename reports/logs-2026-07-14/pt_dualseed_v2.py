"""DUAL-SEED PT v2. Fixes over v1 (A frozen at ceiling, B collapsed):
...
dev = "cuda"; RCTX = 2.5; L_BOX = 0.368; RHO = 1.149; BULK = RHO * L_BOX ** 3; BIGL = 100.0
...
NR = len(BETAS)
OUT = "reports/logs-2026-07-14/pt_dualseed_v2.pt"
